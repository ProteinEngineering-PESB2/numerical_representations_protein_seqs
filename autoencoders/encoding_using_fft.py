...
df_export.to_csv("{}{}_fft_encoding_v2.csv".format(path_output, suffix_output), index=False)
domain_export.to_csv("{}{}_fft_domain_v2.csv".format(path_output, suffix_output), index=False)